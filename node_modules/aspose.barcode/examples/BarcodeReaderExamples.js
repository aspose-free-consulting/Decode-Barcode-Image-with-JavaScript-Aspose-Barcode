...
let Generator = barcode.AsposeBarcode.Generator;
let BarcodeGenerator = Generator.BarcodeGenerator;
let BarcodeReader = Reader.BarcodeReader;
...
class BarcodeReaderExamples
{
    ...
    howToReadFromFile()
    {
        ...
        console.log(test_assist.is_exists(full_path));
    ...
    howToGetCodeBytes()
    {
        ...
        let reader = new BarcodeReader(test_assist.loadImageByName(this.subfolder, fileName), null, null);
         reader.readBarCodes().forEach(function(result, i, results)
    {
    ...
    howToRecognitionCode128()
    {
        ...
        try
        {
            ...
            let reader = new BarcodeReader(test_assist.loadImageByName(this.subfolder, fileName), null, DecodeType.CODE_128);
             reader.readBarCodes().forEach(function(result, i, results)
        {
    ...
    howToRecognitionCode11()
    {
        ...
        try
        {
            ...
            let reader = new BarcodeReader(test_assist.loadImageByName(this.subfolder, fileName), null, DecodeType.CODE_11);
          reader.readBarCodes().forEach(function(result, i, results)
        {
            console.log("Code Text : " +result.getCodeTypeName());
            console.log("\n");
    ...
    howToRecognitionCodeAllSupportedTypes()
    {
        ...
        {
            let fileName = "example2.jpg";
            let reader = new BarcodeReader(test_assist.loadImageByName(this.subfolder, fileName), null, DecodeType.ALL_SUPPORTED_TYPES);
             reader.readBarCodes().forEach(function(result, i, results)
        {
            console.log("Code Text : " +result.getCodeTypeName());
            console.log("\n");
    ...
    howToMacroPdf417()
    {
        ...
        let gen = new BarcodeGenerator(EncodeTypes.MACRO_PDF_417, null);
        ...
        let image = gen.generateBarcodeImage("PNG");
    ...
    howToCustomerInformationInterpretingType1()
    {
        ...
        let generator = new Generator.BarcodeGenerator(EncodeTypes.AUSTRALIA_POST, null);
        generator.setCodeText("59123456781234567");
        generator.getParameters().getBarcode().getAustralianPost().setAustralianPostEncodingTable(CustomerInformationInterpretingType.N_TABLE);
        let image = generator.generateBarcodeImage("PNG");
