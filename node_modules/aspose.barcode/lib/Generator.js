...
class BarcodeGenerator extends assist.BaseJavaClass
{
    ...
    generateBarcodeImage(format_name)
    {
        ...
        {
            throw new assist.BarcodeException(e)
        }
    }
...
class BarcodeParameters extends assist.BaseJavaClass
{
    ...
    {
        this.getJavaClass().setBarCodeHeightSync(value.getJavaClass());
    ...
    {
        this.getJavaClass().setBarCodeWidthSync(value.getJavaClass());
...
class Pdf417Parameters extends assist.BaseJavaClass
{
     ...
     * @return The file size field contains the size in bytes of the entire source file, type - number
     */
     ...
     * @param value The file size field contains the size in bytes of the entire source file, type - number
     */
     ...
     * @return The checksum field contains the value of the 16-bit (2 bytes) CRC checksum using the CCITT-16 polynomial, type - number
     */
     ...
     * @param value The checksum field contains the value of the 16-bit (2 bytes) CRC checksum using the CCITT-16 polynomial, type - number
     */
 ...
 * </p>
 */
class ExtCodetextBuilder extends assist.BaseJavaClass
{
 ...
 * QR structured append parameters.
 */
class QrStructuredAppendParameters extends assist.BaseJavaClass
{
    init()
    {
        // TODO: Implement init() method.
